        ...
        return (
            ...
            <nav className="navbar navbar-light navbar-expand bg-light navigation-clean">
                <div className="container"><a className="navbar-brand" href="#">ZENYU</a><button data-toggle="collapse" className="navbar-toggler" data-target="#navcol-1"></button>
                    <div className="collapse navbar-collapse" id="navcol-1"><a className="text-muted ml-auto" href="#">How To Use</a><a className="text-muted ml-auto" href="#">About Us</a><a className="text-muted mx-auto" href="#" style="text-shadow: 0px 0px;">Features</a></div>
                </div>
            </nav>
            <header className="masthead text-white text-center" style="background:url('assets/img/bg-masthead.jpg')no-repeat center center;background-size:cover;">
