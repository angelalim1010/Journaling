      ...
      <Navigation />
        ...
        <Row>
          ...
          <Col className="justify-content" xs={12} md={8}>
            ...
            If a dispute arises between you and Zenyu, our goal is to provide you with a neutral and cost-effective means of resolving the dispute quickly. In the event of 
            ...
            <h5>DISCLAIMER</h5>
            <p>Please review our <a href='/disclaimer'> Disclaimer</a> posted on the Site. By using the Site, you agree to be bound by our Disclaimer, which is incorporated into these 
            Terms of Service.</p>
