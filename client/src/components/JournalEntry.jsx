	...
	render(){
		...
		return(
			<div className= "JournalEntry">
				...
				<Form onSubmit={(e)=>{e.preventDefault();createMood(this.state.value); createJournal(this.state.content, this.state.prompt.prompt.id); 	uploadImage(this.state.base64TextString);this.props.history.push('/dashboard')}}>
